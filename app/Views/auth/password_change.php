            ...
            <div class="card-body p-0">
                ...
                <div class="py-3 px-5 text-center bg-primary">
                    <h5 class="mb-0 fw-bold text-white d-flex align-items-center justify-content-center">
                        <i class="bi bi-shield-lock-fill me-2 h4 mb-0"></i> CHANGE PASSWORD
                    </h5>
                </div>
                
                <div class="p-5 pt-5">
                    <div class="text-center mb-5">
                        <h1 class="fw-bold text-dark display-6 mb-3">Change Password</h1>
                    ...
                    <form action="<?= base_url('password/update') ?>" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold text-dark mb-3">Current Password</label>
                            <input type="password" name="old_password" class="form-control form-control-lg border-0 bg-light rounded-3 py-3" required placeholder="Enter current password" style="background-color: #f8f9fa !important; border: 1px solid #dee2e6 !important;">
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold text-dark mb-3">New Password</label>
                            <div class="position-relative">
                                <input type="password" name="new_password" class="form-control form-control-lg border-0 bg-light rounded-3 py-3" required minlength="8" placeholder="Enter new password" style="background-color: #f8f9fa !important; border: 1px solid #dee2e6 !important;">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="password" name="confirm_password" class="form-control form-control-lg border-0 bg-light rounded-3 py-3" required minlength="8" placeholder="Confirm new password" style="background-color: #f8f9fa !important; border: 1px solid #dee2e6 !important;">
                        </div>
